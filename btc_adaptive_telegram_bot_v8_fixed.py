...
def build_signal(F,state,calibration,market,news,adaptive_intel=None):
...
def run_scan(state,calibration):
    ...
    signal=build_signal(F,state,calibration,market,news,adaptive_intel)
