...
def build_signal(F, state):
    ...
    # LONG and SHORT are scored using independent copies of state.
    # This prevents impulse/retest state changes from one direction
    # affecting the other direction's score.
    ...
    if long_score >= short_score:
        direction, score, agreement, vals, fe = (
            "LONG", long_score, long_ag, long_vals, long_flow
        )
        state["impulse"] = long_state.get("impulse")
    else:
        direction, score, agreement, vals, fe = (
            "SHORT", short_score, short_ag, short_vals, short_flow
        )
        state["impulse"] = short_state.get("impulse")
