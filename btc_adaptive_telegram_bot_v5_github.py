...
def log_signal_csv(
    ...
    try:
        ...
        with open(
            ...
            # ------------------------------------------------
            # Keep the original logging values unchanged.
            # These local variables only avoid the invalid
            # multiline f-string syntax that caused the
            # GitHub Actions SyntaxError.
            # ------------------------------------------------
