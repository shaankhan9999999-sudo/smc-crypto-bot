...
# It only exposes what the sweep engine actually returned.
# ============================================================
...
def sweep_diagnostic(
    ...
    return {
        ...
        "blocked": blocked,
        "threshold": SWEEP_MIN_CONFIRMATION,
        "threshold_pct":
...
# It does NOT participate in scoring or gating.
# ============================================================
