...
def run_once():
    ...
    # 45-minute cooldown is now DIRECTION-SPECIFIC.
    # A previous SHORT can suppress another SHORT for 45 minutes,
    ...
    cooldown = (
        ...
        and (now_ts() - last_ts) < COOLDOWN_MIN * 60
    )
    ...
    if same or cooldown:
        ...
        telegram(
            ...
            f"Reason: {'same signal' if same else 'same-direction cooldown'}"
        )
        save_state(state)
        return
