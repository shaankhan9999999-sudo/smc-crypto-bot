...
def run_swing_bot():
  ...
  # Support & Resistance for Swing (Prior 30 candles on 1H)
  ...
  # 1. SMART HYBRID LONG SETUP (EMA Trend + Crossover or Support Sweep)
  print("🔎 Checking Smart Hybrid Long Setup...")
  is_bullish_trend = (
  ...
  if long_signal_triggered:
    ...
    stop_loss = current_price - (2.0 * current_atr)  # Swing ke liye bada SL
    target = (
        resistance_level
  ...
  # 2. SMART HYBRID SHORT SETUP (Bearish Trend + Crossover or Resistance Sweep)
