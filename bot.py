...
# Telegram Credentials (Confirmed and Matched with BotFather)
...
def run_ultimate_professional_scalper():
    ...
    if bullish_setup:
        ...
        if send_telegram_message(msg):
            print("Flexible Bullish Signal Sent Successfully to Telegram!")
        else:
            print("Failed to send Telegram message. Please ensure you have clicked 'Start' on @Shaank46bot in Telegram.")
        ...
        if send_telegram_message(msg):
            print("Flexible Bearish Signal Sent Successfully to Telegram!")
        else:
            print("Failed to send Telegram message. Please ensure you have clicked 'Start' on @Shaank46bot in Telegram.")
    else:
