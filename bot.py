...
# --- आपके Telegram Bot Token और Chat ID को बिल्कुल सही तरीके से सेट कर दिया गया है ---
TELEGRAM_BOT_TOKEN = "8662975391:AAG86xC9Dcx-Ec91jKveAnnNqtk4jqDkdr0"  #[span_4](start_span)[span_4](end_span)
TELEGRAM_CHAT_ID = "7500472109"  #[span_5](start_span)[span_5](end_span)
...
def run_scalp_bot():
  print("=" * 60)
  print(
      "🔍 [SCAN START] Scanning BTC-USD with Dual-Side Smart Hybrid & Sweep"
      " Logic..."
  )
  print("=" * 60)
  ...
  # Bullish Smart Hybrid Conditions (Support Sweep / Bear Trap / Trend)
  trend_bullish = (current_price > ema_50) and (current_rsi > 30)
  ema_bullish_crossover = ema_9 > ema_50
  bottom_wick_sweep = (current_low < support_level) and (
      current_price > support_level
  )

  # Bearish Smart Hybrid Conditions (Resistance Sweep / Bull Trap / Trend)
