...
def run_ultimate_professional_scalper():
    print("Scanning BTC-USD on Coinbase (Flexible Ultimate Multi-Timeframe SMC + POC + EMAs + VWAP)...")
    ...
    # --- D. 3-Minute Liquidity Sweep Logic (Flexible: Lookback increased to 25) ---
    ...
    # --- E. 1-Minute FVG (Fair Value Gap) & Volume Imbalance (Flexible: Volume multiplier lowered to 1.2) ---
    ...
    aggressive_volume = m1_curr['volume'] > (vol_ma * 1.2)
    ...
    # Proximity checks (Flexible: VWAP range 1% and POC range 0.8%)
