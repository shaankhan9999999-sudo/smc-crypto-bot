...
def run_balanced_multitimeframe_bot():
  ...
  # ==========================================
  # DYNAMIC LOGIC SETUP (NEW ADDITION)
  # ==========================================
  ...
  # 2. Dynamic EMA 200 Override Logic (Updated to 1.7x Sweet Spot)
  ...
  # --- LAYER 0: Pre-Breakout Pressure Detector (Using Dynamic Volume) ---
  pre_breakout_long = (
      is_near_resistance
  ...
  # --- TIER 1: Heavy Volume Breakout Strategy (Using Dynamic Volume) ---
  ...
  # --- TIER 2: Smart Hybrid Zone & Wick Sweep Setup (Using Dynamic EMA & Dynamic Vol) ---
  ...
  # --- TIER 3: Low-Volume Pullback Continuation Setup with Macro Zone Safety (Using Dynamic EMA) ---
  ...
  # --- TIER 4: EMA 200 Macro Golden & Death Cross Engine (Left Intouched as requested) ---
